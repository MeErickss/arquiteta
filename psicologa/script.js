...
// Troca de ambiente pelas logos
document.querySelectorAll('[data-switch-url]').forEach((switchLink) => {
  const switchEnvironment = () => {
    window.location.href = switchLink.dataset.switchUrl;
  };
  switchLink.addEventListener('click', switchEnvironment);
